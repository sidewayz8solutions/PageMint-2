    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-accent-50 py-16 sm:py-20 lg:py-28 px-4 sm:px-0">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center pt-16 sm:pt-0">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-neutral-900 sm:text-5xl lg:text-6xl xl:text-7xl leading-tight">
            Launch Your SaaS
            <span className="text-primary-600"> in Hours</span>
            <br className="hidden sm:block" />
            <span className="sm:hidden"> </span>
            Not Weeks
          </h2>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-relaxed text-neutral-600 max-w-3xl mx-auto px-4 sm:px-0">
